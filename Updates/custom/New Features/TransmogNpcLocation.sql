...
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `spawndist`, `MovementType`) VALUES (9000441, 190010, 0, 1, -8990.55, 854.122, 105.905, 5.33068, 25, 25, 0, 0);
INSERT INTO `creature` (`guid`, `id`, `map`, `spawnMask`, `position_x`, `position_y`, `position_z`, `orientation`, `spawntimesecsmin`, `spawntimesecsmax`, `spawndist`, `MovementType`) VALUES (9000442, 190010, 1, 1, 1510.95, -4222.21, 40.2768, 0.618855, 25, 25, 0, 0);
